...
@st.cache_data(show_spinner="正在加载看板数据...", ttl=600)
...
@st.cache_data(show_spinner="正在加载环比数据...", ttl=600)
...
@st.cache_data(show_spinner="正在加载队列数据...", ttl=600)
